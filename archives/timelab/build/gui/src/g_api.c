...
void set_tlsig_val(t_tlsig *x, t_tlsmp val){
...
void scale_tlsig_vals(t_tlsig *x, t_tlsmp val){
...
void multiply_tlsigs(t_tlsig *x, t_tlsig *y){
...
void divide_tlsigs(t_tlsig *x, t_tlsig *y){
...
void add_tlsigs(t_tlsig *x, t_tlsig *y){
...
void subtract_tlsigs(t_tlsig *x, t_tlsig *y){
...
void cpy_tlsigs(t_tlsig *x, t_tlsig *y){
...
void init_all(void){
  ...
  g_soundout->buff_pos_w = 0;
  g_soundout->buff_pos_r = 0;
  g_soundout->buff = malloc(sizeof(t_tlsmp) * g_soundout->buff_len * g_outchannels);  
  for(i=0; i<g_soundout->buff_len; i++)
    g_soundout->buff[i] = 0.0;
