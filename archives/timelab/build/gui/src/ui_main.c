...
static void foo(GtkWidget *button){}

static void filer_close(gpointer *x){
...
static void new_output_file(GtkWidget *button, GtkWindow *window){
  ...
  label = gtk_label_new(x->full_path);
  gtk_box_pack_start(GTK_BOX(global_box3), label, TRUE, FALSE, 0);
  gtk_widget_show(label);

  hbox = gtk_hbox_new(FALSE, 10);
  gtk_box_pack_start(GTK_BOX(global_box3), hbox, FALSE, FALSE, 0);
  gtk_widget_show(hbox);
  
  menu_button =  gtk_button_new_with_label("select signal");
  g_signal_connect(menu_button, "clicked", G_CALLBACK(foo), NULL);
  gtk_box_pack_start(GTK_BOX(hbox), menu_button, FALSE, FALSE, 0);
  gtk_widget_show(menu_button);

  close_button =  gtk_button_new_with_label("close");
  g_signal_connect(close_button, "clicked", G_CALLBACK(filer_close), (gpointer) x);
...
void create_gui(void){
  ...
  /* g_signal_connect(button, "clicked", G_CALLBACK(cb_audio_on), NULL); */
  /* gtk_box_pack_start(GTK_BOX(box1), button, FALSE, FALSE, 0); */
  /* gtk_widget_show(button); */

  /* button = gtk_button_new_with_label("Stop Audio"); */
  /* g_signal_connect(button, "clicked", G_CALLBACK(cb_audio_off), NULL); */
  /* gtk_box_pack_start(GTK_BOX(box1), button, FALSE, FALSE, 0); */
  /* gtk_widget_show(button); */
