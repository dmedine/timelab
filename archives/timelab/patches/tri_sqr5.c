...
static t_tlsmp tri(t_tlsmp *data, t_tlsmp slp, t_tlsmp gain){

  t_tlsmp out = tanh_clip(data[1], gain) * slp;
  ...
  for(i=0; i< s; i++)
    {
	  ...
	  if(dir0 ==SLP_UP) slp = slp_up0;
	  if(dir0 ==SLP_DN) slp = slp_dn0;
